...
- `/submissions/submit` — the Submit page: the upload form (Teacher / AI Feedback / Portfolio coming-soon), preselecting an exercise when `?exercise_uid=` is carried. The one Submit route.
