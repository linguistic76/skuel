...
class CalendarOptimizationService:
    ...
    Source Tag: "calendar_optimization_service_explicit"
    - Format: "calendar_optimization_service_explicit" for user-created relationships
    - Format: "calendar_optimization_service_inferred" for system-generated relationships

    Confidence Scoring:
    - 0.9+: User explicitly defined relationship
    - 0.7-0.9: Inferred from calendar_optimization metadata
