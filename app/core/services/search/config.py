...
Usage:
    ...
    fields = SEARCH_FIELD_CONFIG[EntityType.LESSON].text_fields

    # Check if a field is searchable
    if "content" in SEARCH_FIELD_CONFIG[EntityType.LESSON].text_fields:
...
SEARCH_FIELD_CONFIG: dict[EntityType | NonKuDomain, SearchFieldConfig] = {
    ...
    # =========================================================================
    EntityType.LESSON: SearchFieldConfig(
