"""
Report Request Models (Tier 1 - External)
==========================================

Pydantic models for report API validation and serialization.
Handles input validation at the API boundary for report generation.
"""
