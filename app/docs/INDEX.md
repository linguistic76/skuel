...
| [Dead-doc-links sweep queue](roadmap/dead-doc-links-sweep-queue.md) | The live-docs residue of the B1–B4 arc (871 → 343): per-directory split, the tail shape that decides the fix (180 of 223 targets are genuinely gone, so fix the citing prose), heavy hitters, ride-along protocol — plus three disproven claims about files that exist, which the scanner is blind to |
