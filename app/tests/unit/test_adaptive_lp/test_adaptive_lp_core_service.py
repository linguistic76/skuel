...
def create_mock_tasks_service() -> Mock:
    ...
    task1.status = ActivityStatus.COMPLETED
    ...
    task2.status = ActivityStatus.COMPLETED
    ...
    task3.status = ActivityStatus.COMPLETED
    ...
    task4.status = ActivityStatus.COMPLETED
    ...
    task5.status = ActivityStatus.COMPLETED
