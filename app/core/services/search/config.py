...
SEARCH_FIELD_CONFIG: dict[EntityType, SearchFieldConfig] = {
    # =========================================================================
    ...
    # =========================================================================
    EntityType.FINANCE: SearchFieldConfig(
...
def get_search_fields(entity_type: EntityType) -> tuple[str, ...]:
    """
...
def get_array_fields(entity_type: EntityType) -> tuple[str, ...]:
    """
...
def get_filter_fields(entity_type: EntityType) -> tuple[str, ...]:
    """
