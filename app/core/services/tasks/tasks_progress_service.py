...
class TasksProgressService(BaseService["BackendOperations[TaskKu]", TaskKu]):
    ...
    Source Tag: "tasks_progress_service_explicit"
    - Format: "tasks_progress_service_explicit" for user-created relationships
    - Format: "tasks_progress_service_inferred" for system-generated relationships

    Confidence Scoring:
    - 0.9+: User explicitly defined relationship
    - 0.7-0.9: Inferred from tasks_progress metadata
