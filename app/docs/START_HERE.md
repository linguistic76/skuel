...
## 2. The 21 Entity Types

Everything in SKUEL is an **Entity** — a frozen Python dataclass stored as a Neo4j node. The `entity_type` field says which kind it is. There are 21 types in four groups:
