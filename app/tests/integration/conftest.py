...
# ============================================================================
# Domain Backend Fixtures (for user-entity tracking tests)
# ============================================================================
...
@pytest_asyncio.fixture
async def events_backend(neo4j_container):
    """Create UniversalNeo4jBackend for events."""
    from neo4j import AsyncGraphDatabase
    ...
    backend = UniversalNeo4jBackend[Event](driver, "Event", Event)
...
@pytest_asyncio.fixture
async def habits_backend(neo4j_container):
    """Create UniversalNeo4jBackend for habits."""
    from neo4j import AsyncGraphDatabase
    ...
    backend = UniversalNeo4jBackend[Habit](driver, "Habit", Habit)
...
async def services(neo4j_container):
    ...
    raw_tasks_backend = UniversalNeo4jBackend[Task](driver, "Task", Task)
    tasks_backend = TestBackendWrapper(raw_tasks_backend, Task)

    raw_goals_backend = UniversalNeo4jBackend[Goal](driver, "Goal", Goal)
