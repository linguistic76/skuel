    ...
    return Card(
        CardBody(
            ...
            Form(
                ...
                **{
                    "hx-post": f"/api/teaching/review/{submission_uid}/report",
            ...
            Form(
                ...
                Div(
                    ...
                    Button(
                        ...
                        type="button",
                        **{
                            "hx-post": f"/api/teaching/review/{submission_uid}/approve",
                            "hx-target": "#review-result",
                            "hx-swap": "innerHTML",
                ...
                **{
                    "hx-post": f"/api/teaching/review/{submission_uid}/revision",
                    "hx-target": "#review-result",
                    "hx-swap": "innerHTML",
                },
            ),
