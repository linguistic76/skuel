...
def test_input_with_aria_attributes():
    ...
    # Test input with error (SKUEL API uses error_text=)
...
def test_textarea_with_aria_attributes():
    ...
    # Test textarea with error (SKUEL API uses error_text=)
...
def test_select_with_aria_attributes():
    ...
    # Test select with error (SKUEL API uses error_text=, options as children)
