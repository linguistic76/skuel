"""
Form Templates API - PathStep Linking Routes
==============================================

Domain-specific routes for FormTemplate PathStep embedding.
...
def create_form_templates_api_routes(
    ...
    **_kwargs: Any,
    ...
    This function only handles domain-specific PathStep linking.
    """
    ...
    async def link_form_to_path_step(request: Request, current_user: Any = None) -> Result[bool]:
        ...
        parsed = await parse_json_body(request, FormPathStepLinkRequest)
        if parsed.is_error:
