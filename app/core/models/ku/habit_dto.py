    ...
    def from_dict(cls, data: dict[str, Any]) -> HabitDTO:
        ...
        return dto_from_dict(
            ...
            datetime_fields=[
                ...
                "last_completed", "started_at", "completed_at",
            ],
    ...
    def update_from(self, updates: dict[str, Any]) -> None:
        ...
        update_from_dict(
            ...
            allowed_fields={
                ...
                "polarity", "habit_category", "habit_difficulty",
                "current_streak", "best_streak", "total_completions",
                "total_attempts", "success_rate", "last_completed",
                "cue", "routine", "reward",
                "reinforces_identity", "identity_votes_cast", "is_identity_habit",
                "target_identity", "identity_evidence_required",
                "started_at", "completed_at",
                "duration_minutes", "recurrence_pattern", "recurrence_end_date",
                "recurrence_parent_uid", "target_days_per_week", "preferred_time",
                "reminder_time", "reminder_days", "reminder_enabled",
                "source_learning_step_uid", "source_learning_path_uid",
                "curriculum_driven", "curriculum_practice_type",
            },
            enum_mappings={
                "ku_type": EntityType,
                "status": EntityStatus,
