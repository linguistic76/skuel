...
| **SKUEL023** | a `core/` class's `backend` — assigned or only declared — typed against an adapter class, `Any`, or nothing at all | Type against the `core/ports` protocol (ADR-044) |
