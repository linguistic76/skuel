...
- Navbar has icon links: **C** (Curriculum, `/curriculum`) and **S** (Study, `/study`) + avatar **U** (click → `/profile`; hover → Activity dropdown: Tasks, Goals, Habits, Events, Choices, Principles) + logout icon
