...
status: current
category: domains
tags: [habits, activity-domain, domain]
---
...
| Config | `HABIT_CONFIG` in `/core/services/relationships/domain_configs.py` |
...
from core.models.habit.habit import HabitFrequency
