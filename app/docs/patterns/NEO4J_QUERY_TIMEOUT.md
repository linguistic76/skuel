...
- **Tests:** `tests/unit/test_timed_driver.py` (12 tests — fake-session captures the `Query` object), `tests/integration/test_timed_driver.py` (5 tests against `neo4j:2026.04.0` testcontainer; busy Cartesian-product Cypher — no APOC, per SKUEL001).
