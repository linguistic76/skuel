...
the streak backfill) would have reused this predicate. It was closed as moot on 2026-09-23 by
defect 3's ruling that a habit is completed at most once a day. See [habit-completion-persistence-bundle.md](../habit-completion-persistence-bundle.md).
