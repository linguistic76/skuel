...
| `UserEntryOrchestrator` | `user_entry_orchestrator.py` | 10 | UserEntry (Submissions + Journals / Timeline; owns `get_exercise_report_view` + `submit_file_with_learning_context` compositions) |
