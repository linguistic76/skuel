...
between SubmissionFeedback and the next Submission. In the MVP, only the teacher
...
1. **AI contribution**: Scalable — generates targeted instructions from feedback
   ...
   from the SubmissionFeedback and maps them to new exercise instructions.
...
- AI generation could use the same LLM infrastructure as SubmissionFeedback
