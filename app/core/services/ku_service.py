...
class KuService(FacadeDelegationMixin):
    ...
    - KuOrganizationService: ORGANIZES relationships (any Ku can organize others)
    ...
    if TYPE_CHECKING:
        ...
        from core.services.ku.ku_organization_service import OrganizationView
    ...
    _delegations = merge_delegations(
        ...
        # Organization delegations (ORGANIZES relationships — any Ku can organize others)
        {
            "organize": ("organization", "organize"),
            "unorganize": ("organization", "unorganize"),
            "reorder": ("organization", "reorder"),
            "is_organizer": ("organization", "is_organizer"),
            "get_organization_view": ("organization", "get_organization_view"),
            "find_organizers": ("organization", "find_organizers"),
            "list_root_organizers": ("organization", "list_root_organizers"),
            "get_organized_children": ("organization", "get_organized_children"),
        },
    )
    ...
    def __init__(
        ...
        **January 2026 - Factory Pattern (Architecture Consistency Review):**
        ...
        self.logger.debug(
            "KuService initialized via factory (9 sub-services, circular dependency handled)"
        )
