"""
Admin Routes - User Management API
===================================
...
logger = get_logger("skuel.routes.admin")


def create_admin_routes(_app, rt, services):
    """
    ...
    Args:
        ...
        rt: Route decorator
        services: Service container with user_service
    """
    ...
    async def change_user_role(
        ...
        result = await services.user_service.update_role(
            target_user_uid=uid,
            new_role=new_role,
            admin_user_uid=current_user.uid,
        )
    ...
    async def deactivate_user(
        ...
        result = await services.user_service.deactivate_user(
            target_user_uid=uid,
            admin_user_uid=current_user.uid,
            reason=reason,
        )
    ...
    async def activate_user(
        ...
        Returns:
            JSON object with updated user details
        """
        result = await services.user_service.activate_user(
            target_user_uid=uid,
            admin_user_uid=current_user.uid,
        )
    ...
    async def generate_reset_token(
        ...
        result = await services.graph_auth.admin_generate_reset_token(
            user_uid=uid,
    ...
    logger.info("   - GET /api/admin/users/get?uid=... - Get user details")
    logger.info("   - POST /api/admin/users/role?uid=... - Change role")
    logger.info("   - POST /api/admin/users/deactivate?uid=... - Deactivate")
    logger.info("   - POST /api/admin/users/activate?uid=... - Activate")
    logger.info("   - POST /api/admin/users/reset-password?uid=... - Generate reset token")
