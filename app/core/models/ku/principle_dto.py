...
class PrincipleDTO(UserOwnedDTO):
    ...
    def from_dict(cls, data: dict[str, Any]) -> PrincipleDTO:
        ...
        return dto_from_dict(
            ...
            list_fields=[
                "tags", "expressions", "key_behaviors",
                "alignment_history",
                "potential_conflicts", "conflicting_principles",
    ...
    def update_from(self, updates: dict[str, Any]) -> None:
        ...
        update_from_dict(
            ...
            allowed_fields={
                ...
                "statement",
                "principle_category", "principle_source", "strength",
                "tradition", "original_source", "personal_interpretation",
                "expressions", "key_behaviors",
                "current_alignment", "alignment_history", "last_review_date",
                "potential_conflicts", "conflicting_principles", "resolution_strategies",
                "origin_story", "evolution_notes",
                "is_active", "adopted_date",
            },
            enum_mappings={
                "ku_type": EntityType,
                "status": EntityStatus,
