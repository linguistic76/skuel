...
- **Inline suppression:** `# skuel-lint: disable=SKUELXXX -- <reason>` (line) or `# skuel-lint: disable-file=SKUELXXX -- <reason>` (file-level). Supported: SKUEL005, SKUEL011–SKUEL015, SKUEL017–SKUEL025, SKUEL027. Every lint run audits suppressions; one that suppresses nothing is flagged as SKUEL026 — delete it.
