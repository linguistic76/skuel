...
class TaskDTO:
    ...
    def from_dict(cls, data: dict) -> "TaskDTO":
        ...
        return cls(
            ...
            status=EntityStatus(data["status"]),  # String → enum
...
class Task:
    ...
    def progress_percentage(self) -> float:
        ...
        """
        progress_map = {
            EntityStatus.DRAFT: 0.0,
            EntityStatus.SCHEDULED: 10.0,
            EntityStatus.ACTIVE: 50.0,
            EntityStatus.COMPLETED: 100.0,
            EntityStatus.CANCELLED: 0.0,
        }
