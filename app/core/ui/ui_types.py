...
class LessonData:
    ...
    Attributes:
        ...
        lesson_type: Type of lesson (video, interactive, hands_on)
...
class ModuleData:
    ...
    Attributes:
        ...
        status: Module status (completed, in_progress, not_started)
        lessons: List of lessons in this module
    """
...
class LearningPathDetail:
    ...
    Attributes:
        ...
        learners: Number of learners enrolled
        progress: User's progress percentage (0-100)
        is_enrolled: Whether user is enrolled
        curriculum: List of modules in the path
        prerequisites: List of prerequisite path UIDs or skills
