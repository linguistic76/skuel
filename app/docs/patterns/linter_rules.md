...
The anywhere-markers keep scanning per piece, preserving their per-line granularity; a rendered whole carrying an anywhere-marker is skipped at the composite level so one f-string or concat cannot report twice.
