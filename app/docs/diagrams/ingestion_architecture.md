...
flowchart TD
    ...
    M --> R["Reconcile Deletions<br/>(tracked file missing on disk →<br/>delete entity + chunks + metadata)"]
    K --> R
    R --> N["Return IncrementalStats<br/>(skip_efficiency, entities_deleted)"]
