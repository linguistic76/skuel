...
# ADR-010: Moc-Core-Service Query Architecture
...
**Complexity Score:** 38 (if applicable)
...
**Auto-Generated ADR Stub**

This ADR was automatically generated by the architecture review trigger system.

**Query Location:** `core/services/moc/moc_core_service.py:358`
**Complexity Score:** 38
**Message:** Very high query complexity (score: 38) - architecture review recommended

**Next Steps:**
1. Review the query using the architecture review checklist
2. Fill in the Context, Decision, Alternatives, and Consequences sections
3. Document the complexity breakdown and performance characteristics
4. Get sign-off from reviewers
