...
- **~94 typed return types** — protocol methods return specific models/TypedDicts, not `Result[Any]` (March 2026)
- **61 TypedDicts** in `query_types.py` — 20 input types + 41 output result types (March 2026)
