...
class ConversationSessionUpdateRequest(BaseModel):
    ...
    # Learning metrics
    new_insights_generated: int | None = Field(default=None, ge=0)
    cross_domain_connections_made: int | None = Field(default=None, ge=0)
    actionable_recommendations: int | None = Field(default=None, ge=0)
...
class DomainInteractionRequest(BaseModel):
    ...
    context: str | None = Field(default=None, max_length=500, description="Interaction context")
...
class AskesisAnalyticsRequest(BaseModel):
    ...
    analytics_type: str = Field(default="overview", description="Type of analytics")
