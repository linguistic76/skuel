...
- `tests/unit/scripts/test_cypher_linter.py` — 103 tests covering CYP001–CYP006, CYP009, CYP011, CYP012, Python query extraction, `.cypher` statement extraction, file discovery, helpers
