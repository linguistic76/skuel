...
if TYPE_CHECKING:
    from core.ports.user_entry_protocols import UserEntryAssessmentOperations
...
class ReportMasteryService:
    ...
    async def propagate_mastery(
        ...
        update_result = await self.user_entry_backend.update_entry_score(submission_uid, score)
