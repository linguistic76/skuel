...
2. **Submission-driven mastery updates** — When a submission receives feedback, update the mastery score on the related KU. Good feedback → mastery increases. Revision needed → mastery decreases. Wire: `EntryReport` creation → mastery adjustment.
