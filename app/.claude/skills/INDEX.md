...
> Quick navigation for all SKUEL project-specific Claude skills.
...
| Embeddings/GenAI Setup | `/docs/development/GENAI_SETUP.md`, `/docs/architecture/SEARCH_ARCHITECTURE.md` |
