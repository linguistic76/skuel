...
class PathStepCreateRequest(CreateRequestBase):
    ...
    description: str | None = Field(default=None, max_length=2000, description="Step description")

    # Content
    content: str | None = Field(default=None, description="Body text / markdown content")
    summary: str | None = Field(default=None, max_length=500, description="Brief summary")

    # Curriculum placement
    learning_path_uid: str | None = Field(default=None, description="Parent LP UID")
    sequence: int | None = Field(default=None, ge=1, description="Order in learning path")
    ...
    sel_category: SELCategory | None = Field(default=None, description="SEL category lens")
    ...
    confidence: Confidence | None = Field(
        default=None, description="Admin-assessed certainty about this path step"
    )
...
class LearningPathCreateRequest(CreateRequestBase):
    ...
    description: str | None = Field(default=None, max_length=2000, description="Path description")
    ...
    estimated_hours: float | None = Field(default=None, gt=0.0, description="Total estimated hours")
    ...
    tags: list[str] = Field(default_factory=list, description="Tags")
    confidence: Confidence | None = Field(
        default=None, description="Admin-assessed certainty about this learning path"
    )
...
class LearningPathFilterRequest(BaseModel):
    ...
    duration: str | None = Field(default=None, description="Filter by time commitment")
...
class PathStepPathRequest(BaseModel):
    ...
    sequence: int | None = Field(default=None, ge=0, description="Position in path (for attach)")
...
class StepContentUpdateRequest(BaseModel):
    ...
    title: str | None = Field(
        default=None, min_length=1, max_length=200, description="Optional title update"
    )
