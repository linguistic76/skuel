    ...
    def update_from(self, updates: dict[str, Any]) -> None:
        ...
        update_from_dict(
            ...
            allowed_fields={
                ...
                "goal_type", "timeframe", "measurement_type",
                "target_value", "current_value", "unit_of_measurement",
                "start_date", "target_date", "achieved_date",
                "milestones", "progress_percentage", "last_progress_update",
                "progress_history",
                "vision_statement", "why_important", "success_criteria",
                "potential_obstacles", "strategies",
                "fulfills_goal_uid", "source_learning_path_uid",
                "inspired_by_choice_uid", "selected_choice_option_uid",
