...
- [LEARNING_LOOP_ARCHITECTURE.md](/docs/architecture/LEARNING_LOOP_ARCHITECTURE.md) — Askesis scaffolds the learning loop (PathStep → Exercise → Submission → Report → RevisedExercise)
