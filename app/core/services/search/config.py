...
Usage:
    ...
    fields = SEARCH_FIELD_CONFIG[EntityType.PATH_STEP].text_fields

    # Check if a field is searchable
    if "content" in SEARCH_FIELD_CONFIG[EntityType.PATH_STEP].text_fields:
...
SEARCH_FIELD_CONFIG: dict[EntityType | NonKuDomain, SearchFieldConfig] = {
    ...
    EntityType.PATH_STEP: SearchFieldConfig(
        # Matches PsCoreService._config.search_fields = ("title", "intent", "description").
