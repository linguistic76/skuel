...
# EntityType.from_string() handles most aliases (e.g. "ku" -> CURRICULUM, "ls" -> LEARNING_STEP),
...
class ParsedActivityLine:
    ...
    **Fields:**
    ...
    def get_linked_knowledge(self) -> list[str]:
        ...
        uids.extend([link["id"] for link in self.links if link.get("type") in (EntityType.ARTICLE.value, EntityType.KU.value)])
        return uids
