...
class AskesisService(FacadeDelegationMixin):
    """
    Facade coordinating all Askesis intelligence sub-services.
    ...
    Architecture:
    - Zero business logic (pure delegation via FacadeDelegationMixin)
    ...
    FacadeDelegationMixin Usage (January 2026):
    - Simple delegations (10 methods) auto-generated via _delegations dict
    ...
    # Class-level type annotations for signature preservation (FacadeDelegationMixin)
    ...
    # Auto-generate 9 simple delegation methods
    # NOTE: analyze_user_state is now explicit (orchestrates recommendations + analysis)
    # NOTE: 13-Domain Intelligence methods (8) remain explicit due to factory logic
    _delegations = merge_delegations(
        # State Analysis delegations (2 methods - analyze_user_state now explicit)
        {
            "identify_patterns": ("state_analyzer", "identify_patterns"),
            "calculate_system_health": ("state_analyzer", "calculate_system_health"),
        },
        # Recommendation delegations (3 methods)
        {
            "get_next_best_action": ("recommendation_engine", "get_next_best_action"),
            "optimize_workflow": ("recommendation_engine", "optimize_workflow"),
            "predict_future_state": ("recommendation_engine", "predict_future_state"),
        },
        # Query Processing delegations (2 methods)
        {
            "answer_user_question": ("query_processor", "answer_user_question"),
            "process_query_with_context": ("query_processor", "process_query_with_context"),
        },
        # Context Retrieval delegations (2 methods)
        {
            "get_learning_context": ("context_retriever", "get_learning_context"),
            "analyze_knowledge_gaps": ("context_retriever", "analyze_knowledge_gaps"),
        },
    )
    ...
    # ========================================================================
    #
    # The following 9 methods are auto-generated by FacadeDelegationMixin:
    #
    ...
    # ========================================================================
    # DELEGATED METHOD STUBS (for mypy - FacadeDelegationMixin overwrites at runtime)
    # ========================================================================
...
def create_askesis_service(
    ...
    Args:
        ...
        habits_service: HabitsService for entity extraction
        events_service: EventsService for entity extraction
        intelligence_factory: UserContextIntelligenceFactory for 13-domain synthesis

    Returns:
        AskesisService: Configured service instance (facade pattern)
    """
    return AskesisService(
        graph_intelligence_service=graph_intelligence_service,
        user_service=user_service,
        llm_service=llm_service,
        embeddings_service=embeddings_service,
...
# Legacy alias removed - class renamed directly to AskesisService
