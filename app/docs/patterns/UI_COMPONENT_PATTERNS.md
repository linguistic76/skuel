...
- `/adapters/inbound/teaching_ui.py` - Two-level sidebar: teaching sidebar (Students default, Review Queue, Groups) with `title_icon="graduation-cap"` + Alpine section sidebar (student detail)
