...
def create_visualization_api_routes(
    ...
    Args:
        ...
        rt: Route decorator
        visualization_service: VisualizationService instance
        tasks_service: Optional tasks service
        habits_service: Optional habits service
        calendar_service: Optional calendar service
        goals_service: Optional goals service
    ...
    async def get_goal_gantt(request: Request, goal_uid: str) -> JSONResponse:
        ...
        if goals_service:
            ...
            tasks = []
            tasks_result = await goals_service.relationships.get_goal_tasks(goal_uid)
