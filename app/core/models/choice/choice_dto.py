    ...
    def from_dict(cls, data: dict[str, Any]) -> ChoiceDTO:
        ...
        return dto_from_dict(
            ...
            datetime_fields=[
                ...
                "decision_deadline", "decided_at",
            ],
            list_fields=[
                "tags", "options",
                "decision_criteria", "constraints",
                "stakeholders", "lessons_learned",
            ],
    ...
    def update_from(self, updates: dict[str, Any]) -> None:
        ...
        update_from_dict(
            ...
            allowed_fields={
                ...
                "choice_type", "options", "selected_option_uid",
                "decision_rationale", "decision_criteria",
                "constraints", "stakeholders",
                "decision_deadline", "decided_at",
                "satisfaction_score", "actual_outcome", "lessons_learned",
                "inspiration_type", "expands_possibilities",
            },
            enum_mappings={
                "ku_type": EntityType,
                "status": EntityStatus,
