"""
Nous Routes - Worldview MOC Documentation Section.

Serves content from the /nous directory powered by moc_nous.md.
Replaces the /docs routes with a cleaner architecture.
...
- Similar to a public wiki or documentation site
- View tracking requires authentication (optional enhancement)
"""
...
def create_nous_routes(_app, rt, services: "Services"):
    """
    Create nous routes.
    ...
    Args:
        ...
        rt: Route decorator
        services: Services container for Neo4j KU queries
    """
    ...
    # Log startup info
    moc = get_moc_structure()
    logger.info("Nous routes registered")
